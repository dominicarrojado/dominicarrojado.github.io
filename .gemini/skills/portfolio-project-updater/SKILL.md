...
description: Expertise in adding or modifying showcase projects in the portfolio (lib/constants.ts). Use when updating project highlights, inserting new work, or configuring showcase links.
---
...
3. **Verify Asset Placement:** Prompt the user to confirm that placeholder images/GIFs are placed in the `public/images/projects/` directory matching the metadata paths.
4. **Compile Check:** Execute `yarn build` or `yarn lint` to ensure that standard code updates are compiling cleanly.

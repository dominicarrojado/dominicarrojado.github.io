...
To start, you would need to set up your local development for MJML framework, I've written a [separate post](/posts/how-to-setup-local-development-for-mjml-framework/) just for that, but you can also just clone the [boilerplate](https://github.com/dominicarrojado/mjml-email-framework-boilerplate) to save time:

---
name: seo-validator
description: Audit and maintain search engine optimization (SEO) best practices on Next.js pages. Use when validating metadata, sitemap configs, or SEO tags.
---
...
3. **Verify Sitemap Configuration:** Check the sitemap generation logic configured inside `next-sitemap.config.js` to ensure generated maps cover dynamic post routing correctly.
